			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Enter Vendor Opening Balance</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Enter Vendor Opening Balance</span></li>
						...
						<div class="col-md-6">
								...
								<?php
									if(isset($_POST['submit']))
										...
										$sql1 = "INSERT INTO billing_purchase_transaction(transaction_type,purchase_id,item_price) VALUES ('$transaction_type','$purchase_id','$item_price')";
											  mysql_query($sql1);
											  echo mysql_error();
							...
							<form id="form" action="" class="form-horizontal" method="post">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Enter Venddor Opening Balance</h2>
									</header>
