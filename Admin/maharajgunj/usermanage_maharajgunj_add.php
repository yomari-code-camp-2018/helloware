								...
								<?php
                                    if(isset($_POST['submit']))
                                    {
                                      ...
                                      $status = $_POST['status'];
                                        ...
                                        $sql3 = mysql_query("SELECT user_name FROM helloworld_maharajgunj.billing_user WHERE user_name='$user_name'");
                                            if (mysql_num_rows($sql3) != 0)
                                                {
                                                echo '<p class="error" style="color:red;">User Name is already exits. Please <a href="usermanage_maharajgunj.php">click</a> here.</p>';
                                                }
                                            else
                                                {
                                        $sql = "INSERT INTO helloworld_maharajgunj.billing_user(first_name,last_name,user_name,user_password,user_address,user_mobile,user_email,status) VALUES('$first_name','$last_name','$user_name','$user_password','$user_address','$user_mobile','$user_email','$status')";
                                      		mysql_query($sql);

                                      			

                                      	$sql2 = "INSERT INTO helloworld_maharajgunj.billing_user_access (user_name) VALUES('$user_name')";
                                    ...
                                    if($result)
                                        echo '<p class="success" style="color:#FA1919;">Your User Entry Successfully. Please <a href="usermanage_maharajgunj.php">click</a> here. </p>';
                                      else
