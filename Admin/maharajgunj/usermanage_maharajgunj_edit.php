...
if(isset($_POST['submit1']))
{
  ...
  $sql1 = "UPDATE helloworld_maharajgunj.billing_user SET user_address='$user_address', user_password='$user_password', user_mobile='$user_mobile', user_email='$user_email', status='$status' WHERE user_name='$user_name' ";
  mysql_query($sql1);

  
  header("Location: usermanage_maharajgunj.php"); exit;
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<?php
						$user_name=$_GET['user_name']; 
						$sql = mysql_query("SELECT * FROM helloworld_maharajgunj.billing_user WHERE user_name='$user_name'") or die(mysql_error());
