                                      ...
                                      $user_email = $_POST['user_email'];
                                        ...
                                        $sql3 = mysql_query("SELECT user_name FROM helloworld_koteshwor.billing_user WHERE user_name='$user_name'");
                                            if (mysql_num_rows($sql3) != 0)
                                                {
                                                echo '<p class="error" style="color:red;">User Name is already exits. Please <a href="usermanage_koteshwor.php">click</a> here.</p>';
                                                }
                                            else
                                                {
                                        $sql = "INSERT INTO helloworld_koteshwor.billing_user(first_name,last_name,user_name,user_password,user_address,user_mobile,user_email) VALUES('$first_name','$last_name','$user_name','$user_password','$user_address','$user_mobile','$user_email')";
                                      		mysql_query($sql);
