					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><a href="Active"><span>Maharajgunj</span></a></li>
						...
						<div class="col-md-6">
								<?php
									if(isset($_POST['submit']))
										...
										$result = mysql_query("INSERT INTO helloworld.billing_stock (product_name, stock_out, user_name, branch_name)
									            VALUES('$product_name', '$stock_out', '$user_name', '$branch_name')") or die(mysql_error());

									            if($result)

									    $result1 = mysql_query("INSERT INTO helloworld_maharajgunj.billing_stock (product_name, stock_in, user_name)
									            VALUES('$product_name', '$stock_out', '$user_name')") or die(mysql_error());

									            if($result1)        	
							                    echo '<p class="success" style="color:#FA1919;">Your Transaction Successfully Entered. Please <a href="check_out_to_branch.php">click</a> here. </p>';
							                  else
								...
								<section class="panel">
									...
									<div class="panel-body">
					                    ...
					                    <div class="form-group">
						                  ...
						                  <div class="col-md-8">
						                    <input type="text" class="form-control" name="user_name" id="profileFirstName" value="<?php echo $row["user_name"]; ?>" readonly="readonly">
						                  </div>
					                	</div> <br>
					                	<div class="form-group">
						                  	<label class="col-md-4 control-label" for="branch_name">Branch Name</label>
						                  <div class="col-md-8">
						                    <input type="text" class="form-control" name="branch_name" id="profileFirstName" value="Maharajgunj" readonly="readonly">
						                  </div>
					                	</div> <br>
