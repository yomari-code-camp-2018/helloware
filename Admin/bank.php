						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="bank_add.php"><button class="btn btn-primary">Add Bank </button></a>
										</div>
									</div>
								</div>
								<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
									<?php
						                $sql = mysql_query("SELECT * FROM billing_bank ORDER BY bank_id ") or die(mysql_error());
						                while($row = mysql_fetch_object($sql))
						                {
						                	print '<tr class="gradeA">';
						                	print '<td>'.$row->bank_id.'</td>';
