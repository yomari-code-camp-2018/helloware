						...
						<div class="col-md-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Branch Control</h2>
								</header>
								<div id="ExampleLoadMorePrependTarget" class="panel-body" style="min-height: 150px;">
	                                ...
	                                <?php
	                                    if($row->branch_control_koteshwor)
	                                        {?>

	                                    <div class="col-md-3">
                                    	<a href="./koteshwor/index.php"><button type="button" class="mb-xs mt-xs mr-xs btn btn-lg btn-primary">Koteshwor</button></a>
                                	</div>
	                                ...
	                                ?>
	                                <?php
	                                    if($row->branch_control_maharajgunj)
	                                        {?>

	                                    <div class="col-md-3">
                                    	<a href="./maharajgunj/index.php"><button type="button" class="mb-xs mt-xs mr-xs btn btn-lg btn-primary">Maharajgunj</button></a>
                                	</div>
                                	...
                                	<div class="col-md-3">
                                    	<a href="./pulchowk/index.php"><button type="button" class="mb-xs mt-xs mr-xs btn btn-lg btn-primary">Pulchowk</button></a>
                                	</div>
                                	<div class="col-md-3">
                                    	<a href="./maharajgunj/index.php"><button type="button" class="mb-xs mt-xs mr-xs btn btn-lg btn-primary">Maharajgunj</button></a>
                                	</div> -->
