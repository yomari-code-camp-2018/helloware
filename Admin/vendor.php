					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><a href="#"><span>Vendor</span></a></li>
							</ol>
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="vendor_add.php"><button class="btn btn-primary">Add Vendor </button></a>
										</div>
									</div>
								</div>
								<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<tbody>
									<?php
						                $sql = mysql_query("SELECT * FROM billing_vendor ORDER BY vendor_id") or die(mysql_error());
						                while($row = mysql_fetch_object($sql))
						                {
						                	print '<tr class="gradeA">';
						                	print '<td>'.$row->vendor_id.'</td>';
						                	print '<td>'.$row->vendor_name.'</td>';
						                	print '<td>'.$row->vendor_loc.'</td>';
						                	print '</tr>';
						                }
						            ?>
									</tbody>
