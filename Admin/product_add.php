                                    ...
                                    if(isset($_POST['submit']))
                                        ...
                                        $query = mysql_query("SELECT product_name FROM billing_product WHERE product_name='$product_name'");
                                            if (mysql_num_rows($query) != 0)
                                                ...
                                                $result = mysql_query("INSERT INTO billing_product (product_name, category_name, product_price)
								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<select class="form-control" required name="category_name">
	                                                ...
	                                                <?php 
	                                                    $option = mysql_query("SELECT category_name from billing_category");
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" name="product_price" class="form-control" placeholder="eg.: Enter the price of the product"/>
											</div>
										</div><br>
