					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Cash Received</span></li>
								<li><span>Add Cash Received</span></li>
							</ol>
						...
						<div class="col-md-6">
								...
								<?php
									if(isset($_POST['submit']))
										...
										$sql1 = "INSERT INTO billing_sales_transaction(transaction_type,sales_id,sales_paid) VALUES ('$transaction_type','$sales_id','$sales_paid')";
											  mysql_query($sql1);
											  echo mysql_error();
									...
									<div class="panel-body">
										...
										<?php 
                                    		...
                                    		<div class="form-group">
		                                        ...
		                                        <div class="col-md-9">
		                                           <input type="text" class="form-control" name="transaction_type" readonly value="Sales Paid">
		                                        </div>
                                    		</div>
                                    	<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="sales_paid" class="form-control" placeholder="Amount" required />
											</div>
										</div>
									</div>
