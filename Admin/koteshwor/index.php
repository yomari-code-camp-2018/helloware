						...
						<div class="col-md-12">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Koteshwor Branch</h2>
								</header>
								<div id="ExampleLoadMorePrependTarget" class="panel-body" style="min-height: 150px;">
									
                                	<div class="col-md-3">
                                    	<a href="usermanage_koteshwor.php"><button type="button" class="mb-xs mt-xs mr-xs btn btn-lg btn-primary">User Control</button></a>
                                	</div>
                                	<div class="col-md-3">
