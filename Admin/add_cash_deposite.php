						...
						<div class="col-md-6">
								...
								<?php
									if(isset($_POST['submit']))
										...
										$result = mysql_query("INSERT INTO billing_bank_balance (transaction_type,deposite_date,transaction,transaction_by,credit,bank_name)
									            VALUES('Deposite','$deposite_date','$transaction','$transaction_by','$credit','$bank_name')") or die(mysql_error());
							...
							<form id="form" action="" class="form-horizontal" method="post">
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Transaction Name<span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="transaction" class="form-control" placeholder="Transaction Name" required />
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Transaction By <span class="required">*</span></label>
											<div class="col-sm-9">
