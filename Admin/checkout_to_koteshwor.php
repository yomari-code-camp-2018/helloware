						...
						<div class="col-md-6">
								<?php
									if(isset($_POST['submit']))
									    ...
									    $result1 = mysql_query("INSERT INTO helloworld_koteshwor.billing_stock (product_name, stock_in, user_name)
								...
								<section class="panel">
									...
									<div class="panel-body">
					                	...
					                	<div class="form-group">
						                  ...
						                  <div class="col-md-8">
						                    <input type="text" class="form-control" name="branch_name" id="profileFirstName" value="Koteshwor" readonly="readonly">
						                  </div>
					                	</div> <br>
