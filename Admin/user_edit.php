...
if(isset($_POST['submit1']))
{
  ...
  $sql1 = "UPDATE billing_user SET user_address='$user_address', user_password='$user_password', user_mobile='$user_mobile', user_email='$user_email', status='$status' WHERE user_name='$user_name' ";
  mysql_query($sql1);
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<select class="form-control" name="status"> 
													<?php print '<option style="background-color: #CCC;" value="'.$row->status.'" selected>'.$row->status.'</option>';
													?>
