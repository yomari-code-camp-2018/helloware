									...
									<div id="cash" class="tab-pane active">
										...
										<form class="form-horizontal" action="purchase_transaction_vendor.php" method="post">
					                        ...
					                        if(isset($_POST["search"])){
					                          ...
					                          $sql="SELECT  * FROM helloworld.billing_vendor WHERE vendor_name LIKE '%$vendor_name%'";
					                        }
					                        else{
					                        $sql="SELECT * FROM helloworld.billing_vendor";
					                        }
											...
											<select class="form-control" name="vendor_name" required>
													...
													<?php 
									                    	$option = mysql_query("SELECT * FROM helloworld.billing_vendor");
