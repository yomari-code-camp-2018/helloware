								...
								<div class="tabs">
									...
									<div class="panel-body col-md-12">
										<table class="table table-bordered table-striped mb-none" id="datatable-editable">
											...
											<tbody>
												<?php
									                $sql = mysql_query("SELECT service_by, sum(product_price*billing_qty)AS total_service, sum(product_price*billing_qty)*0.015 AS percentage FROM billing_sales_order GROUP BY service_by;") or die(mysql_error());
									                $counter=0;
