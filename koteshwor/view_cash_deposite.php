							...
							<form id="form" action="cash_deposite.php" class="form-horizontal" method="post">
								<section class="panel">
									<header class="panel-heading">
										...
										<?php
											$bb_id=$_GET['bb_id']; 
											$sql = mysql_query("SELECT * FROM helloworld.billing_bank_balance WHERE bb_id='$bb_id'") or die(mysql_error());
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" name="credit" class="form-control" readonly="" value="<?php print ''.$row->credit.'';?>">
											</div>
										</div>
										<div class="form-group">
