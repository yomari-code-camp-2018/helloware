								...
								<?php
									if(isset($_POST['submit']))
									    ...
									    $result1 = mysql_query("INSERT INTO helloworld_maharajgunj.billing_stock (product_name, stock_in, user_name, branch_name)
									            VALUES('$product_name', '$stock_out', '$user_name', 'Koteshwor')") or die(mysql_error());
								...
								<section class="panel">
									...
									<div class="panel-body">
					                	...
					                	<div class="form-group">
						                  ...
						                  <div class="col-md-8">
						                    <input type="text" class="form-control" name="branch_name" id="branch_name" value="Maharajgunj" readonly="readonly">
						                  </div>
					                	</div> <br>
