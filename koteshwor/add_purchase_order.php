...
<?php
	...
	//edit qty
		...
		$sql = mysql_query("INSERT INTO billing_purchase_transaction (purchase_id, product_name, item_price, item_quantity, branch_name, transaction_type) VALUES('$purchase_id', '$product_name', '$item_price', '$item_quantity', 'Koteshwor','Purchase')")
