							...
							<section class="panel">
										<header class="panel-heading">
											...
											<h2 class="panel-title"><?php
											            $expense_date = $_GET['expense_date'];
														$sql = mysql_query("SELECT *, sum(expense_amount) as dayexp FROM billing_expense WHERE expense_date= CURDATE()") or die(mysql_error());
									...
									<div class="panel-body">
										<table class="table table-bordered table-striped mb-none" id="datatable-editable">
											...
											<?php
											    $expense_date = $_GET['expense_date'];
							                    $sql="SELECT * FROM billing_expense WHERE expense_date=CURDATE() ORDER BY expense_id";
