...
<?php
	if(isset($_POST['submit1']))
	{
		...
		$sql = mysql_query("INSERT INTO billing_purchase (purchase_id, vendor_name, user_name, branch_name) VALUES('$purchase_id', '$vendor_name', '$user_name', 'Maharajgunj')")
							...
							<div class="col-xs-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Purchase Return</h2>
									</header>
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="add_purchase_order1.php" method="post">
											<div class="form-group">
												...
												<div class="col-md-4">
														<select data-plugin-selectTwo required="" class="form-control populate" name="product_name" id="product_name">
															...
															<?php
																$sql5 = mysql_query("SELECT * FROM helloworld.billing_product WHERE category_name='Product'") or die(mysql_error());
													...
													<div class="col-md-2">
														<input type="number" min="1" name="purchase_paid" class="form-control" required="" placeholder="Enter Price">
													</div>
													<?php   
														$purchase_id = $_GET['purchase_id'];
									...
									<div class="panel-body col-md-12">
										<table class="table table-bordered table-striped mb-none" id="datatable-editable">
											...
											<tbody>
												<?php
												    $purchase_id = $_GET['purchase_id'];
									                $sql = mysql_query("SELECT *, purchase_paid, sum(item_quantity) AS totalqty, sum(purchase_paid) AS totalprice, sum(purchase_paid * item_quantity) AS totalpurchase FROM billing_purchase_transaction WHERE purchase_id='$purchase_id' GROUP BY product_name") or die(mysql_error());
									                $counter=0;
									                while($row = mysql_fetch_object($sql))
									                {
									                	print '<tr>';
									            ...
									            ?>
									          	<?php 
			                                		 $sql = mysql_query("SELECT sum(item_quantity*purchase_paid) AS tran_total FROM billing_purchase_transaction WHERE purchase_id='$purchase_id'") or die(mysql_error());
